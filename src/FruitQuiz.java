...
public class FruitQuiz extends KeyAdapter {
	...
	void makeQuestions() {
		...
		question2 = new JLabel("<html>Which is a fruit? <br> A: Avocado <br> B: Potato <br> C: Carrots</html>");
		question3 = new JLabel(
				"<html>What is nancy's favorite fruit? <br> A: Apples <br> B: Pineapple <br> C: Oranges</html>");
		question4 = new JLabel("<html>How old is Michelle? <br> A: 17 <br> B: 19 <br> C: 18</html>");
